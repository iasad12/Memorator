...
Memorator is a secure, client-side, purely browser-based tool designed to parse, combine, view, and beautifully export your personal chat histories into sleek PDFs (Ebooks) or comprehensive text scripts. 
...
- **Advanced UX:** Group participant exclusion, smart aliases mapping, auto-detecting timestamps, duplicate checking, and dynamic responsive views.
- **Data Caching:** Save and load massive browser-state snapshots via IndexedDB instantly.

## How to Get Your Data

### Meta Messenger
Go to your Facebook/Meta account settings and request to "Download your information". Select Messages and choose either JSON or HTML format. You can drag the resulting folders into this tool.
